...
Class FCKeditor
	...
	Public Function CreateHtml( instanceName )
		...
		If IsCompatible() Then
			...
			html = html & "<textarea id=""" & instanceName & """ name=""" & instanceName & """ >" & Server.HTMLEncode( sValue ) & "</textarea>"
			' Render the configurations hidden field.
			'html = html & "<input type=""hidden"" id=""" & instanceName & "___Config"" value=""" & GetConfigFieldString() & """ style=""display:none"" />"
			html = html & "<textarea id=""" & instanceName & "___Config"" name=""" & instanceName & "___Config"" >" & GetConfigFieldString() & "</textarea>"
