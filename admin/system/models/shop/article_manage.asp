...
<td width="550">&nbsp;<%=db_title%>&nbsp;名称\标题</td>
...
<td align="center"><input name="edit_item" type="checkbox" class="delitem" value="<%=rs("id")%>" /></td>
<td>&nbsp;
...
<input type="button" class="button update" value="修改" onClick="window.location.href='article_edit.asp?id=<%=rs("id")%>' "/>
</td></tr>
<%
	rs.movenext
	next
