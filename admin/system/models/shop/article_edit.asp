...
<tr class="forumRow"><td align="right">标题：</td><td><input type="text" name="tf_title" id="tf_title" value="<%=tf_title%>" />

</td></tr>
<tr class="forumRow">
  <td align="right">小图片：</td>
  <td><input name="tf_small_pic" id="tf_small_pic" type="text" value="<%=tf_small_pic%>" size="45" maxlength="255" />
<input type=button value="浏览图片" onClick="showUploadDialog('image', 'FormE.tf_small_pic', '')" class="button"/> 
&nbsp;208px*178px </td></tr>

<tr class="forumRow">
  <td align="right">大图片：</td>
  <td><input name="tf_big_pic" id="tf_big_pic" type="text" value="<%=tf_big_pic%>" size="45" maxlength="255" />
...
<tr class="forumRow">
  ...
  <td><textarea name="tf_note" cols="45" rows="4" id="tf_note"><%=tf_note%></textarea>
...
<iframe id="tf_content___Frame" src="../../public/editbox/fckeditor/editor/fckeditor.html?InstanceName=tf_content&amp;Toolbar=Mini" width="90%" height="100" frameborder="0" scrolling="no"></iframe>
</td></tr>
