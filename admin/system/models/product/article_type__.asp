...
<td align="center" style="width:120px;"><span class="mainTitle">修改操作</span></td>
</tr>
...
<td align="center"><a href="?add_id_b=<%=row_b("id")%>"><img src="<%=Rpath%>public/images/ico/add_class_s.gif" width="9" height="9" border="0" /></a></td>
<td align="left">
...
<a href="?order=up&id_b=<%=row_b("id")%>"><img src="<%=Rpath%>public/images/ico/up_ico.gif" width="12" height="12" border="0"></a>
<a href="?order=down&id_b=<%=row_b("id")%>"><img src="<%=Rpath%>public/images/ico/down_ico.gif" width="12" height="12"></a>
</td>
<td align="center">
<input name="update2" type="submit" class="button" value="修改" />
...
<td width="20" align="center"><a href="?add_id_b=<%=row_b("id")%>"><img src="<%=Rpath%>public/images/ico/add_class_s.gif" width="9" height="9" border="0" /></a></td>
...
<img src="<%=Rpath%>public/images/ico/up_ico.gif" width="12" height="12"></a>
<a href="?order=down&id_b=<%=row_b("id")%>&id_s=<%=row_s("id")%>">
<img src="<%=Rpath%>public/images/ico/down_ico.gif" width="12" height="12"></a>
</td>

<td align="center">
<input name="update" type="submit" class="button" value="修改" />
